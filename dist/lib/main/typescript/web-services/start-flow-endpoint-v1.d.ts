...
export declare class StartFlowEndpointV1 implements IWebServiceEndpoint {
    readonly options: IStartFlowEndpointV1Options;
    static readonly CLASS_NAME = "StartFlowEndpointV1";
    private readonly log;
    private readonly apiUrl?;
    get className(): string;
    constructor(options: IStartFlowEndpointV1Options);
    getAuthorizationOptionsProvider(): IAsyncProvider<IEndpointAuthzOptions>;
    get oasPath(): (typeof OAS.paths)["/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-corda/startFlow"];
    /**
