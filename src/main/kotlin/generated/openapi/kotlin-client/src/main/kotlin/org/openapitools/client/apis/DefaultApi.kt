...
class DefaultApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     * @return RequestConfig
     */
    fun listCPIV1RequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    fun startFlowV1(startFlowV5Request: StartFlowV5Request) : StartFlowV1Response {
        val localVarResponse = startFlowV1WithHttpInfo(startFlowV5Request = startFlowV5Request)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun startFlowV1WithHttpInfo(startFlowV5Request: StartFlowV5Request) : ApiResponse<StartFlowV1Response?> {
        val localVariableConfig = startFlowV1RequestConfig(startFlowV5Request = startFlowV5Request)
     ...
     * @return RequestConfig
     */
    fun startFlowV1RequestConfig(startFlowV5Request: StartFlowV5Request) : RequestConfig<StartFlowV5Request> {
