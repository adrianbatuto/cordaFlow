...
class ApiPluginLedgerConnectorCordaController(@Autowired(required = true) val service: ApiPluginLedgerConnectorCordaService) {
    ...
    fun startFlowV1( @Valid @RequestBody startFlowV5Request: StartFlowV5Request): ResponseEntity<StartFlowV1Response> {
        return ResponseEntity(service.startFlowV1(startFlowV5Request), HttpStatus.valueOf(200))
    }
